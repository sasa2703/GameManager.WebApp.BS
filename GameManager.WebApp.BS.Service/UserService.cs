...
using UserModel = GameManager.WebApp.BS.Entities.Models.User;
...
namespace GameManager.WebApp.BS.Service
{
    public sealed class UserService : IUserService
    {
        ...
        public async Task<(UserForUpdateDto userToPatch, GameManager.WebApp.BS.Entities.Models.User userEntity)> GetUserForPatchAsync(int userId, bool trackChanges)
        {
        ...
        public async Task SaveChangesForPatchAsync(UserForUpdateDto userToPatch, GameManager.WebApp.BS.Entities.Models.User userEntity)
        {
